...
class TESTCAST_CHELIANGJIBENXINXI(TESTCASE):
    ...
    def cheliangjibenxinxi_search(self):
        ...
        self.dr.find_element_by_xpath('//*[@id="951"]').click()
        self.dr.switch_to.frame('iframeb')
        time.sleep(3)
        self.assertEqual('车辆信息列表',self.dr.find_element_by_xpath('/html/body/div[1]/div').text,'车辆信息')

    def test1_cheliangjibenxinxi_search_cphm(self):
        ...
        self.assertEqual(search_value_cphm,self.dr.find_element_by_xpath('/html/body/div[1]/div/div/div[1]/div[1]/div[1]/div[2]').text,'校验详情页面车牌号')
        self.assertEqual(search_value_hpzl,self.dr.find_element_by_xpath('/html/body/div[1]/div/div/div[1]/div[1]/div[2]/div[2]').text,'校验详情页面车牌类型')
        self.assertEqual(search_value_ower,self.dr.find_element_by_xpath('/html/body/div[1]/div/div/div[1]/div[1]/div[3]/div[2]').text,'校验详情页面车辆所有人')
