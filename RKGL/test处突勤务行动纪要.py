...
class TESTCAST_CTQWXDJY(TESTCASE):
    ...
    def test1_ctqwxdjy_add(self):
        ...
        time.sleep(1)
        self.dr.find_element_by_xpath('//*[@id="dutytreeSelect_8_switch"]').click()
        time.sleep(1)
        self.dr.find_element_by_xpath('//*[@id="dutytreeSelect_10_switch"]').click()
        time.sleep(1)
        self.dr.find_element_by_xpath('//*[@id="dutytreeSelect_12_span"]').click()
        time.sleep(1)
        self.assertEqual('马芬',self.dr.find_element_by_xpath('//*[@id="leadingByCadre"]').get_attribute('value'),'校验和部队组成信息管理模块的关联')
    ...
    def test6_ctqwxdjy_search_dutyGroupName(self):
        self.ctqwxdjy_search()
        search_value_dutyGroupName='边防2组'
        self.dr.find_element_by_xpath('//*[@id="dutyGroupName"]').click()
        time.sleep(1)
        self.dr.find_element_by_xpath('//*[@id="dutytreeSelect_8_switch"]').click()
        time.sleep(1)
        ...
        self.dr.find_element_by_xpath('//*[@id="list"]/tbody/tr/td[10]/a').click()
        self.assertEqual('BF21002',self.dr.find_element_by_xpath('//*[@id="dutyGroupName"]').get_attribute('value'),'校验详情页面执勤编组')
        self.dr.implicitly_wait(5)
        self.dr.find_element_by_xpath('/html/body/a').click()
        time.sleep(2)
