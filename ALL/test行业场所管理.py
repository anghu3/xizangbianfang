...
class TESTCAST_HANGYECHANGSUO(TESTCASE):
    ...
    def test1_hangyechangsuo_add(self):
        ...
        self.dr.find_element_by_xpath('//*[@id="pcstreeSelect_45_span"]').click()
        self.dr.find_element_by_xpath('//*[@id="locatedPoliceAreaName"]').click()
        self.dr.find_element_by_xpath('//*[@id="jqtreeSelect_2_switch"]').click()
        time.sleep(1)
        self.dr.find_element_by_xpath('//*[@id="jqtreeSelect_45_switch"]').click()
        time.sleep(1)
        self.dr.find_element_by_xpath('//*[@id="jqtreeSelect_47_span"]').click()
